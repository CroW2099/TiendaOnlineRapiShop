...
public class CategoriaServicio {
	...
	public Categoria actualizar(Categoria categoriaActualizar) {
		Categoria categoriaActual = repositorio.findById(categoriaActualizar.getcat_id()).get();
		categoriaActual.setcat_id(categoriaActualizar.getcat_id());
		categoriaActual.setcat_nom(categoriaActualizar.getcat_nom());
		categoriaActual.setcat_desc(categoriaActualizar.getcat_desc());;
